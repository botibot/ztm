...
let newArray = greeting.flatMap(x => x.join(' '));
console.log(newArray);

//#3 Turn the greeting array above into a string: 'Hello young grasshopper you are learning fast!'
let newString = greeting.flatMap(y => y.join(' ')).join(' ');
...
//#8 change the output array of question #7 back into an object with all the users IDs 
//updated to their new version. Should output: { user1: 36546, user2: 185666, user3: 180630 }
const newUsers = Object.fromEntries(updatedUsersArray);
